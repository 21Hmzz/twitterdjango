"""
Django settings for erttiwt project.
...
SECRET_KEY = 'django-insecure-w=oi8=0)f6#i-@vstkqr6y$8syv2ih2*h66q-^yv_*u90^=px#'
...
WSGI_APPLICATION = 'erttiwt.wsgi.application'
